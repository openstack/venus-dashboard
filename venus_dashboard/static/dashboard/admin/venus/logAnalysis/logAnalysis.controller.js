(function () {
  ...
  angular
      ...
      .controller('LogAnalysisController', LogAnalysisController);

  LogAnalysisController.$inject = ['$scope', 'venusSrv'];

  function LogAnalysisController($scope, venusSrv) {
    ...
    $scope.getData = function () {
      ...
      venusSrv.getAnalysis(config).then(function (res) {
        $scope.tableData = [];
